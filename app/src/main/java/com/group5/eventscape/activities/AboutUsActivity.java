...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvTermOfSer = findViewById(R.id.cvTermOfSer);
        cvPrivacyPolicy = findViewById(R.id.cvPrivacyPolicy);
        alert = new AlertDialog.Builder(this);
        alert2 = new AlertDialog.Builder(this);

        cvTermOfSer.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        cvPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                alert2.setTitle("Privacy Policy")
